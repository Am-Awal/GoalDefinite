...
struct SearchView: View {
    ...
    var body: some View {
        // NavigationView enables the "Searchable" capability
        NavigationView {
            ScrollView {
                VStack {
                    content
            ...
            .sheet(isPresented: $show) {
                GoalView(namespace: namespace, goal: goals[selectedIndex], show: $show)
            }
        }
    }
    
    var content: some View {
        ForEach(Array(goals.enumerated()), id: \.offset) { index, item in
